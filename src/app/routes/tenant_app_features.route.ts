...
export class Tenant_App_FeaturesRoutes{
  ...
  private children_array= ["tenant_app_features"];
  onModuleInit() {
        ...
        return async (result) => {
          ...
          try {
            ...
            for (let index = 0; index < result.OnFailureTopicsToPush.length; index++) {
              ...
              errorResult.setSocketId(requestModelOfTenant_App_FeaturesDto.SocketId);
              errorResult.setCommunityUrl(requestModelOfTenant_App_FeaturesDto.CommunityUrl);
              errorResult.setRequestId(requestModelOfTenant_App_FeaturesDto.RequestGuid)
              console.log('socket is inside catch',requestModelOfTenant_App_FeaturesDto.SocketId);
