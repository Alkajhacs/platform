...
export class App_MessagesRoutes{
  ...
  private children_array= ["app_messages"];
        ...
        return async (result) => {
          ...
          try {
            ...
            for (let index = 0; index < result.OnFailureTopicsToPush.length; index++) {
              ...
              let requestModelOfApp_MessagesDto: RequestModel<App_MessagesDto> = result["message"];
              errorResult.setSocketId(requestModelOfApp_MessagesDto.SocketId);
              errorResult.setCommunityUrl(requestModelOfApp_MessagesDto.CommunityUrl);
              errorResult.setRequestId(requestModelOfApp_MessagesDto.RequestGuid)
              console.log('socket is inside catch',requestModelOfApp_MessagesDto.SocketId);
