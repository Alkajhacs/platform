...
export class Feature_PermissionsRoutes{
  ...
  private children_array= ["feature_permissions"];
  onModuleInit() {
        ...
        return async (result) => {
          ...
          try {
            ...
            for (let index = 0; index < result.OnFailureTopicsToPush.length; index++) {
              ...
              errorResult.setSocketId(requestModelOfFeature_PermissionsDto.SocketId);
              errorResult.setCommunityUrl(requestModelOfFeature_PermissionsDto.CommunityUrl);
              errorResult.setRequestId(requestModelOfFeature_PermissionsDto.RequestGuid)
              console.log('socket is inside catch',requestModelOfFeature_PermissionsDto.SocketId);
