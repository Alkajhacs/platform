...
{
  TopicName: "TENANT_USER_APP_ALERTS_ADD",
  Publishers: ["API_GATEWAY_SERVICE"],
  Method: "POST",
  Subscribers: [
    {
      ...
      Function: "InsertChannel",
      OnSuccessTopicsToPush: ["TENANT_USER_APP_ALERTS_ADDED"],
      OnFailureTopicsToPush: ["ERROR_RECEIVER"],
...
{TopicName: "TENANT_USER_APP_ALERTS_UPDATE",
  Publishers: ["API_GATEWAY_SERVICE"],
  Method: "POST",
  Subscribers: [
    {
      Service: "TENANT_USER_APP_ALERTS_SERVICE",
      Function: "InsertChannel",
      OnSuccessTopicsToPush: ["TENANT_USER_APP_ALERTS_UPDATED"],
      OnFailureTopicsToPush: ["ERROR_RECEIVER"],
...
{  TopicName: "TENANT_USER_APP_ALERTS_DELETE",
Publishers: ["API_GATEWAY_SERVICE"],
Method: "POST",
Subscribers: [
  {
    Service: "TENANT_USER_APP_ALERTS_SERVICE",
    Function: "InsertChannel",
    OnSuccessTopicsToPush: ["TENANT_USER_APP_ALERTS_DELETED"],
    OnFailureTopicsToPush: ["ERROR_RECEIVER"],
  ...
  Subscribers: [
    {
      Service: "FEATURE_PERMISSIONS_SERVICE",
      Function: "InsertChannel",
      OnSuccessTopicsToPush: ["FEATURE_PERMISSIONS_UPDATED"],
      OnFailureTopicsToPush: ["ERROR_RECEIVER"],
...
{  TopicName: "FEATURE_PERMISSIONS_DELETE",
Publishers: ["API_GATEWAY_SERVICE"],
Method: "POST",
Subscribers: [
  {
    Service: "FEATURE_PERMISSIONS_SERVICE",
    Function: "InsertChannel",
    OnSuccessTopicsToPush: ["FEATURE_PERMISSIONS_DELETED"],
    OnFailureTopicsToPush: ["ERROR_RECEIVER"],
